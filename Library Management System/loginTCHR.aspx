<%@ Page Title="" Language="C#" MasterPageFile="~/LMS.Master" AutoEventWireup="true" CodeBehind="loginTCHR.aspx.cs" Inherits="Library_Management_System.loginTCHR" %>
                            ...
                            <div class="form-group">
                                <div class="col-md-12 control">
                                    <div style="padding-top: 15px; font-size: 85%">
                                        Don't have an account! <a href="registerTeacher.aspx">
                                            Sign Up Here </a>
                                    </div>
                                </div>
                            </div>
